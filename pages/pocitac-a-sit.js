...
function pocitacasit() {
  return (
    <div className="space-y-3 grid sm:grid-cols-2">
      <Head>
...
okoukat</li>
      ...
      <div>
        ...
        <div>
          ...
          zařízení – některé jsou určeny jen pro konkrétní činnost, některé jsou
          univerzálně použitelné. Počítač se dá propojit s jinými zařízeními (i
          jinými počítači) do různě velké soustavy. Každá součást i zařízení
          mají svůj účel a své důležité vlastnosti, podle kterých si je
          vybíráme.
        </div>
      </div>
    </div>
